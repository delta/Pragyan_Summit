...
<html>
  <head>
    ...
    <meta name="description" content="Pragyan Summit 2016" />
 ...
 <!--                <div class="col-lg-4 col-sm-6 speaker">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="margin-top-0 wow fadeIn">Request an invite</h2>
                    <hr class="primary">
                    <p>Want to attend? Fill out the form below along with your statement of purpose.
    ...
    <footer id="footer">
        <div class="container-fluid">
            <div class="row">
                <center>
                   <span class=" text-muted small">Made with &hearts; by <a href="delta.nitt.edu">Delta Force</a> ©2015</span>
                </center>
            </div>
        </div>
    </footer>
